		...
		<div class="row">
			...
			<strong>Fill UserName and Upload PDF</strong>
				<form method="post" enctype="multipart/form-data">
					...
					?>
								<div class=
								"alert alert-success alert-dismissible show text-center">
									<a class="close" data-dismiss="alert" aria-label="close" onclick="parentNode.remove()">
									×
									</a>
			...
			<div class="card">
				...
				<h4>Records from PDF Database</h4>
				</div>
				<div class="card-body">
